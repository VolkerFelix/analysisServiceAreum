...
def generate_insights(metrics: ActivityMetrics, patterns: ActivityPatterns) -> List[Insight]:
...
def generate_recommendations(metrics: ActivityMetrics, patterns: ActivityPatterns) -> List[Recommendation]:
